/** India states/UTs and their districts, for cascading State → District pickers. */
export const INDIA_STATE_DISTRICTS: Record<string, string[]> = {
  ...
  "Punjab": [
    ...
    "Muktsar", "Pathankot", "Patiala", "Rupnagar", "SAS Nagar (Mohali)", "Sangrur", "SBS Nagar", "Tarn Taran",
  ],
  "Rajasthan": [
